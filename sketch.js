...
function setup(){
    ...
    redBox = Bodies.rectangle(250,320,80,20,redBox_options);
    ...
    greenBox = Bodies.rectangle(380,320,30,120,greenBox_options);
    ...
    yellowBox = Bodies.rectangle(670,320,100,20,yellowBox_options);
